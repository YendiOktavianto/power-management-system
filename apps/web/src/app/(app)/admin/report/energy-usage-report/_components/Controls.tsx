...
export default function Controls({
  show,
  setShow,
  selectedLocation,      // masih ada, tapi UI pakai overlay button
  setSelectedLocation,
  dateFrom,
  setDateFrom,
  dateTo,
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4 text-white text-xs">
      ...
      {/* Location -> pakai overlay */}
      <div className="flex flex-col col-span-1">
        <label className="mb-1 font-semibold">Location</label>
        <button
          type="button"
          className="p-2 rounded-lg bg-[#123060] text-white text-xs w-full text-left"
          onClick={onOpenLocationPicker}
        >
          {locationLabel || "Pilih lokasi"}
        </button>
      </div>
