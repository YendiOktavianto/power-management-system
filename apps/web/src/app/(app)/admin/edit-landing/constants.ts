...
export const ICON_OPTIONS: FeatureIconKey[] = ["FaBolt", "FaChartBar", "FaLock"];
export const API_BASE = process.env.NEXT_PUBLIC_APP_BASE_URL?.replace(/\/+$/, "") || "http://localhost:4000";
export const CONTENT_KEY = process.env.NEXT_PUBLIC_CONTENT_KEY || "landing";
export const UPLOAD_PATH = process.env.NEXT_PUBLIC_UPLOAD_PATH || "/api/v1/upload";
export const DEFAULTS: Content = {
  hero: { heading: "", subheading: "", primaryCta: { label: "", href: "" }, secondaryCta: { label: "", href: "" } },
  about: { brand: "", body: "", stats: [], companyCta: { label: "", href: "" } },
  featuresIntro: { eyebrow: "", headline: "", body: "" },
  features: [],
  products: { title: "", tiles: [], stable: { title: "", body: "", imageSrc: "" } },
  leadership: [],
  contacts: [],
  location: { address: "", hours: "", phone: "", mapsUrl: "", iframeSrc: "" },
  leadershipSection: { title: "Our Leadership Team" },
  contactsSection: {
    title: "Contact Our Team",
    subtitle: "Reach out directly to the right expert. Quick, simple, and professional.",
  },
  locationSection: {
    title: "Our Location",
    subtitle: "Visit our head office or reach out through phone. We’re available during business hours.",
    hqTitle: "Headquarters",
  },
};

export const TEMPLATE_LANDING: Content = {
  hero: {
  ...
  features: [
    { iconKey: "FaBolt", title: "Real-Time Monitoring", desc: "Monitor your devices instantly and gain full control over your energy usage in real time." },
    { iconKey: "FaChartBar", title: "Energy Analytics", desc: "Visualize your energy consumption through detailed, interactive analytics and actionable insights." },
    { iconKey: "FaLock", title: "Data Security", desc: "All your data is encrypted and protected with industry-standard security measures for complete peace of mind." },
  ],
  products: {
    title: "Why Choose Power Management System",
    tiles: [
      { value: "3k +", text: "Businesses already Running on Power Management System" },
      { value: "", text: "PowerSys integrates effortlessly with your existing infrastructure, ensuring a smooth transition without disruptions to your daily workflow." },
    ],
    stable: {
  ...
  location: {
    address: "Jl. Kp Pamahan No 63 Kel. Jatimekar, Kel. Jatiasih Bekasi - Jawa Barat.",
