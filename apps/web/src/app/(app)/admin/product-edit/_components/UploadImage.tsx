...
import type { useLocalToast } from "../useProductEdit";
import { uploadImageToServer } from "../useProductEdit";
...
export default function UploadImage({
  ...
  fieldName?: string;
  maxMB?: number;
  notify?: ReturnType<typeof useLocalToast>;
}) {
      ...
      >
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="text-sm text-white/90">
            {uploading ? "Uploading…" : value ? "Change image" : "Select / drag & drop image here"}
          </div>
