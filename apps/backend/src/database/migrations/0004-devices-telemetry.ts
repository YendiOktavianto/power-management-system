...
export class DevicesTelemetry1700000000004 implements MigrationInterface {
  name = 'DevicesTelemetry1700000000004';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ALTER TABLE "devices"
      ADD CONSTRAINT "FK_devices_location" FOREIGN KEY ("location_id") REFERENCES "locations"("location_id") ON DELETE RESTRICT ON UPDATE NO ACTION
    `);
    await queryRunner.query(`
      ALTER TABLE "devices"
      ADD CONSTRAINT "FK_devices_owner_org" FOREIGN KEY ("owner_org_id") REFERENCES "organizations"("org_id") ON DELETE RESTRICT ON UPDATE NO ACTION
    `);
    await queryRunner.query(`
      ALTER TABLE "devices"
      ADD CONSTRAINT "FK_devices_provisioned_by" FOREIGN KEY ("provisioned_by_user_id") REFERENCES "users"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION
    `);
    ...
    await queryRunner.query(`
      ...
      ADD CONSTRAINT "FK_telemetry_device" FOREIGN KEY ("device_id") REFERENCES "devices"("device_id") ON DELETE CASCADE ON UPDATE NO ACTION
    `);
    await queryRunner.query(`
      ALTER TABLE "telemetry_readings"
      ADD CONSTRAINT "FK_telemetry_cost" FOREIGN KEY ("cost_id") REFERENCES "cost"("cost_id") ON DELETE SET NULL ON UPDATE NO ACTION
    `);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "telemetry_readings" DROP CONSTRAINT "FK_telemetry_cost"`);
    await queryRunner.query(
      `ALTER TABLE "telemetry_readings" DROP CONSTRAINT "FK_telemetry_device"`,
    );
