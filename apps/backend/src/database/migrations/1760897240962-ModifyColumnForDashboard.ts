...
export class ModifyColumnForDashboard1760897240962 implements MigrationInterface {
  name = 'ModifyColumnForDashboard1760897240962';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "address" DROP COLUMN "lattitude"`);
